...
<template>
  <div class="app">
    ...
    <div class="search-box">
      ...
      <button>
        <i class="fa-solid fa-gear"></i> Filtros
      </button>
    </div>
    ...
    <div class="filters">
      ...
      <button>R$500 - R$250</button>
      <button class="remove">Remover filtros</button>
    </div>
    ...
    <!-- AVISO -->
    <section class="tip">
      <span>💜 Salve oportunidades em seus favoritos!</span>
      <span>›</span>
    </section>
